...
def print_sudoku(plansza):
    ...
    # +-----+-----+
    print ("+"+5*"-")*2+"+"
    print "| " + str(plansza[0, 3]) + " " + str(plansza[1, 3]) + " | " + str(plansza[2, 3]) + " " + str(plansza[3, 3]) + " |"
    print "| " + str(plansza[0, 2]) + " " + str(plansza[1, 2]) + " | " + str(plansza[2, 2]) + " " + str(plansza[3, 2]) + " |"
    print ("+" + 5 * "-") * 2 + "+"
    print "| " + str(plansza[0, 1]) + " " + str(plansza[1, 1]) + " | " + str(plansza[2, 1]) + " " + str(plansza[3, 1]) + " |"
    print "| " + str(plansza[0, 0]) + " " + str(plansza[1, 0]) + " | " + str(plansza[2, 0]) + " " + str(plansza[3, 0]) + " |"
    print ("+" + 5 * "-") * 2 + "+"
    print suma
    print
    suma += 1
